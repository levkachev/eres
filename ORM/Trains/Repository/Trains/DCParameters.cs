   ...
   public class DCParameters : BaseTrainParameters
    {
        ...
        /// <summary>
        /// Время сборки цепи в торможение.
        /// </summary>
        ...
        public DCParameters(BaseTrainParameters parameters, Double assemblyPowerCircuitTime,
                            Double disassemblyPowerCircuitTime, Double assemblyPullTime, Double assemblyPullResistance,
                            Double autoModeFactor1, Double lowAutoModeRange, Double highAutoModeRange,
                            Double linearGrowCurrentTime, Int32 connectionPull2, Int32 positionPull2,
                            Int32 weakPull2) : base(parameters)
        {
        ...
        public DCParameters(Int32 numberCars, Double carLength, Double unladenWeight, Double breakAverage,
            Double netResistancePullFactor, Double aerodynamicDragFactor, Double netResistanceCoastingFactor1,
            Double netResistanceCoastingFactor2, Double netResistanceCoastingFactor3, Double trainEquivalentSurface,
            Double inertiaRotationFactor, Double ownNeedsElectricPower, 
                            Double assemblyPowerCircuitTime, 
                            Double disassemblyPowerCircuitTime, Double assemblyPullTime, Double assemblyPullResistance, 
                            Double autoModeFactor1, Double lowAutoModeRange, Double highAutoModeRange, 
                            Double linearGrowCurrentTime, Int32 connectionPull2, Int32 positionPull2, 
                            Int32 weakPull2, 
            ...
            : base(
                ...
                netResistanceCoastingFactor1, netResistanceCoastingFactor2, netResistanceCoastingFactor3,
                trainEquivalentSurface, inertiaRotationFactor, ownNeedsElectricPower, trainName)
        {
            AssemblyPowerCircuitTime = assemblyPowerCircuitTime;
            DisassemblyPowerCircuitTime = disassemblyPowerCircuitTime;
            AssemblyPullTime = assemblyPullTime;
