...
namespace ORM.Stageis.Entities
{
    ...
    /// DTO
    /// </summary>
    public class Stages : Entity<Stages>
    {
        #region Fields
        /// <summary>
        /// </summary>
        ...
        internal Stages(String stageName, IEnumerable<LimitStructure> speedLimit, IEnumerable<LimitStructure> planLimit, IEnumerable<LimitStructure> profileLimit, IEnumerable<LimitStructure> currentSection, IEnumerable<LimitStructure> automaticSpeedControl, IEnumerable<LimitStructure> openSection)
        {
            Name = stageName;
