...
namespace ORM.Stageis.Repository
{
    ...
    /// 
    /// </summary>
    public class StageSRepository : Repository<Stage>
    {
        /// <exception cref="ArgumentNullException">factory is <see langword="null"/></exception>
        internal static StageSRepository GetInstance()
        {
            return GetInstance<StageSRepository>((SessionWrapper.GetInstance().Factory));
        }
